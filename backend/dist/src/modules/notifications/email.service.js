...
let EmailService = EmailService_1 = class EmailService {
    ...
    shipmentCreatedTemplate(context) {
        return `
      <!DOCTYPE html>
      <html>
        <head>
    ...
    shipmentPickedUpTemplate(context) {
        return `
      <!DOCTYPE html>
      <html>
        <head>
    ...
    shipmentInTransitTemplate(context) {
        return `
      <!DOCTYPE html>
      <html>
    ...
    shipmentOutForDeliveryTemplate(context) {
        return `
      <!DOCTYPE html>
      <html>
        <head>
    ...
    shipmentDeliveredTemplate(context) {
        return `
      <!DOCTYPE html>
      <html>
        <head>
    ...
    shipmentFailedTemplate(context) {
        return `
      <!DOCTYPE html>
      <html>
        <head>
    ...
    otpVerificationTemplate(context) {
        return `
      <!DOCTYPE html>
      <html>
        <head>
    ...
    payoutInitiatedTemplate(context) {
        return `
      <!DOCTYPE html>
      <html>
        <body style="font-family: Arial, sans-serif;">
    ...
    payoutCompletedTemplate(context) {
        return `
      <!DOCTYPE html>
      <html>
        <body style="font-family: Arial, sans-serif;">
