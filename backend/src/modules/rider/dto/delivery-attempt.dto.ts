...
export class DeliveryAttemptDto {
  ...
  @ApiProperty({
    description: 'Customer OTP for verification',
    example: '123456',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiPropertyOptional({
    description: 'POD (Proof of Delivery) photo URL',
    example: 'https://storage.example.com/pod/xyz789.jpg',
  })
  @IsString()
  @IsOptional()
  podPhotoUrl?: string;
  ...
  @ApiPropertyOptional({
    description: 'COD amount collected from customer',
    example: 1500,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Delivery notes from rider',
    example: 'Customer requested to leave at security desk',
  })
  @IsString()
  @IsOptional()
  @MaxLength(500)
