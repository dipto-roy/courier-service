...
export class FailedDeliveryDto {
  ...
  @ApiPropertyOptional({ description: 'Additional notes about the failed delivery', example: 'Called customer multiple times, no response' })
  @IsString()
  @IsOptional()
  @MaxLength(500)
  notes?: string;

  @ApiPropertyOptional({ description: 'Photo evidence URL', example: 'https://storage.example.com/failed/abc123.jpg' })
  @IsString()
  @IsOptional()
  photoUrl?: string;
